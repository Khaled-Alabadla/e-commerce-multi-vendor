            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="checkout-steps-form-style-1">
                        <form action="{{ route('front.checkout.create') }}" method="POST">
                            @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text"
                                                            placeholder="Email Address"name="addr[billing][email]">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.select type="text" placeholder="Country"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <input class="form-control" name="addr[billing][state]">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.select type="text" placeholder="Country"
                                                            name="addr[shipping][country]" :options="$countries"
                                                            :selected="request('country')" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Region/State</label>
                                                    <div class="select-items">
                                                        <input class="form-control" name="addr[shipping][state]">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
