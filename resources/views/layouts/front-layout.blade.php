...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href=" {{ asset('siteassets/assets/images/favicon.svg') }} " />

    <!-- ========================= CSS here ========================= -->
    <link rel="stylesheet" href=" {{ asset('siteassets/assets/css/bootstrap.min.css') }} " />
    <link rel="stylesheet" href=" {{ asset('siteassets/assets/css/LineIcons.3.0.css') }} " />
    <link rel="stylesheet" href=" {{ asset('siteassets/assets/css/tiny-slider.css') }} " />
    <link rel="stylesheet" href=" {{ asset('siteassets/assets/css/glightbox.min.css') }} " />
    <link rel="stylesheet" href=" {{ asset('siteassets/assets/css/main.css') }} " />
    @stack('styles')
...
<body>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="top-left">
                            <ul class="menu-top-link">
                                <li>
                                    <form action="{{ route('front.currency.store') }}" method="POST">
                                        @csrf
                                ...
                                <li>
                                    ...
                                    <div class="select-position">
                                        <select id="select5" onchange="window.location.href=this.value">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3 col-7">
                        ...
                        <a class="navbar-brand" href="{{ route('home') }}">
                            <img src="{{ asset('siteassets/assets/images/logo/logo.svg') }}" alt="Logo">
                        </a>
                        <!-- End Header Logo -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-12">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img src=" {{ asset('siteassets/assets/images/logo/white-logo.svg') }}"
                                        alt="#">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="payment-gateway">
                                <span>We Accept:</span>
                                <img src=" {{ asset('siteassets/assets/images/footer/credit-cards-footer.png') }}"
                                    alt="#">
                            </div>
                        </div>
                        <div class="col-lg-4 col-12">
    ...
    <!-- ========================= JS here ========================= -->
    <script src=" {{ asset('siteassets/assets/js/bootstrap.min.js') }} "></script>
    <script src=" {{ asset('siteassets/assets/js/tiny-slider.js') }} "></script>
    <script src=" {{ asset('siteassets/assets/js/glightbox.min.js') }} "></script>
